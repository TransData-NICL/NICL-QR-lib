...
// Hide the include from moc to prevent Qt 5.5 moc double-namespace bug
// (moc sees KItinerary namespace opened in vdvticketcontent.h and then
// reopened here, misinterpreting it as nested KItinerary::KItinerary)
#ifndef Q_MOC_RUN
#include "../vdv/vdvticketcontent.h"
#else
#include <QDateTime>
class VdvTicketValidityAreaData;
template<int> class VdvNumber;
class VdvDateTimeCompact;
#endif
