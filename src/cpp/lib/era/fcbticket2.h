...
#ifndef KITINERARY_FCBTICKET2_H
#define KITINERARY_FCBTICKET2_H
...
/** ERA Flexible Content Barcode (FCB) version 2
...
class GeoCoordinateType {
    UPER_GADGET
    UPER_ELEMENT_DEFAULT(KItinerary::Fcb::v2::GeoUnitType, geoUnit, milliDegree)
    UPER_ELEMENT_DEFAULT(KItinerary::Fcb::v2::GeoCoordinateSystemType, coordinateSystem, wgs84)
    UPER_ELEMENT_DEFAULT(KItinerary::Fcb::v2::HemisphereLongitudeType, hemisphereLongitude, north)
    UPER_ELEMENT_DEFAULT(KItinerary::Fcb::v2::HemisphereLatitudeType, hemisphereLatitude, east)
    UPER_ELEMENT(int, longitude)
    UPER_ELEMENT(int, latitude)
    UPER_ELEMENT_OPTIONAL(KItinerary::Fcb::v2::GeoUnitType, accuracy)
    UPER_GADGET_FINALIZE
};
...
class IssuingData {
    ...
    UPER_ELEMENT_OPTIONAL(KItinerary::Fcb::v2::ExtensionData, extension)
    ...
    UPER_ELEMENT_OPTIONAL(KItinerary::Fcb::v2::GeoCoordinateType, pointOfSale)
    UPER_GADGET_FINALIZE
...
class TravelerType {
    ...
    UPER_ELEMENT_OPTIONAL(KItinerary::Fcb::v2::GenderType, gender)
    ...
    UPER_ELEMENT_OPTIONAL(KItinerary::Fcb::v2::PassengerType, passengerType)
    ...
    UPER_ELEMENT_OPTIONAL(QList<KItinerary::Fcb::v2::CustomerStatusType>, status)
    UPER_GADGET_FINALIZE
};
...
class TravelerData {
    UPER_EXTENDABLE_GADGET
    UPER_ELEMENT_OPTIONAL(QList<KItinerary::Fcb::v2::TravelerType>, traveler)
...
class ViaStationType {
    UPER_EXTENDABLE_GADGET
    UPER_ELEMENT_DEFAULT(KItinerary::Fcb::v2::CodeTableType, stationCodeTable, stationUIC)
    UPER_ELEMENT_OPTIONAL(int, stationNum)
    UPER_ELEMENT_OPTIONAL(QByteArray, stationIA5)
    UPER_ELEMENT_OPTIONAL(QList<KItinerary::Fcb::v2::ViaStationType>, alternativeRoutes)
    UPER_ELEMENT_OPTIONAL(QList<KItinerary::Fcb::v2::ViaStationType>, route)
...
class PolygoneType {
    UPER_GADGET
    UPER_ELEMENT(KItinerary::Fcb::v2::GeoCoordinateType, firstEdge)
    UPER_ELEMENT(QList<KItinerary::Fcb::v2::DeltaCoordinate>, edges)
    UPER_GADGET_FINALIZE
};
...
class ReturnRouteDescriptionType {
    ...
    UPER_ELEMENT_OPTIONAL(QList<KItinerary::Fcb::v2::RegionalValidityType>, validReturnRegion)
    UPER_GADGET_FINALIZE
};
...
class CompartmentDetailsType {
    ...
    UPER_ELEMENT_DEFAULT(KItinerary::Fcb::v2::CompartmentPositionType, position, CompartmentPositionType::unspecified)
    UPER_GADGET_FINALIZE
};
...
class BerthDetailData {
    UPER_EXTENDABLE_GADGET
    UPER_ELEMENT(KItinerary::Fcb::v2::BerthTypeType, berthType)
    UPER_ELEMENT(int, numberOfBerths)
    UPER_ELEMENT_DEFAULT(KItinerary::Fcb::v2::CompartmentGenderType, gender, CompartmentGenderType::family)
    UPER_GADGET_FINALIZE
};
...
class TariffType {
    ...
    UPER_ELEMENT_OPTIONAL(KItinerary::Fcb::v2::RouteSectionType, restrictedToRouteSection)
    UPER_ELEMENT_OPTIONAL(KItinerary::Fcb::v2::SeriesDetailType, seriesDataDetails)
    ...
    UPER_ELEMENT_OPTIONAL(QList<KItinerary::Fcb::v2::CardReferenceType>, reductionCard)
    UPER_GADGET_FINALIZE
};
...
class IncludedOpenTicketType {
    ...
    UPER_ELEMENT_DEFAULT(KItinerary::Fcb::v2::CodeTableType, stationCodeTable, stationUIC)
    UPER_ELEMENT_OPTIONAL(QList<KItinerary::Fcb::v2::RegionalValidityType>, validRegion)
    ...
    UPER_ELEMENT_OPTIONAL(KItinerary::Fcb::v2::TravelClassType, classCode)
    UPER_ELEMENT_OPTIONAL(QByteArray, serviceLevel)
    UPER_ELEMENT_OPTIONAL(QList<int>, carrierNum)
    UPER_ELEMENT_OPTIONAL(QList<QByteArray>, carrierIA5)
    UPER_ELEMENT_OPTIONAL(QList<int>, includedServiceBrands)
    UPER_ELEMENT_OPTIONAL(QList<int>, excludedServiceBrands)
    UPER_ELEMENT_OPTIONAL(QList<KItinerary::Fcb::v2::TariffType>, tariffs)
...
class LuggageRestrictionType {
    ...
    UPER_ELEMENT_OPTIONAL(QList<KItinerary::Fcb::v2::RegisteredLuggageType>, registeredLuggage)
    UPER_GADGET_FINALIZE
};
...
class ReservationData {
    ...
    UPER_ELEMENT_DEFAULT(KItinerary::Fcb::v2::ServiceType, service, seat)
    UPER_ELEMENT_DEFAULT(KItinerary::Fcb::v2::CodeTableType, stationCodeTable, stationUICReservation)
    UPER_ELEMENT_OPTIONAL(int, fromStationNum)
    UPER_ELEMENT_OPTIONAL(QByteArray, fromStationIA5)
    UPER_ELEMENT_OPTIONAL(int, toStationNum)
    UPER_ELEMENT_OPTIONAL(QByteArray, toStationIA5)
    ...
    UPER_ELEMENT_OPTIONAL(QList<int>, carrierNum)
    UPER_ELEMENT_OPTIONAL(QList<QByteArray>, carrierIA5)
    UPER_ELEMENT_DEFAULT(KItinerary::Fcb::v2::TravelClassType, classCode, second)
    UPER_ELEMENT_OPTIONAL(QByteArray, serviceLevel)
    UPER_ELEMENT_OPTIONAL(KItinerary::Fcb::v2::PlacesType, places)
    UPER_ELEMENT_OPTIONAL(KItinerary::Fcb::v2::PlacesType, additionalPlaces)
    UPER_ELEMENT_OPTIONAL(KItinerary::Fcb::v2::PlacesType, bicyclePlaces)
    UPER_ELEMENT_OPTIONAL(KItinerary::Fcb::v2::CompartmentDetailsType, compartmentDetails)
    UPER_ELEMENT_DEFAULT(int, numberOfOverbooked, 0)
    UPER_ELEMENT_OPTIONAL(QList<KItinerary::Fcb::v2::BerthDetailData>, berth)
    UPER_ELEMENT_OPTIONAL(QList<KItinerary::Fcb::v2::TariffType>, tariffs) // "tariff" in the official ASN.1 spec, but that inconsistent with the other document types
    UPER_ELEMENT_DEFAULT(KItinerary::Fcb::v2::PriceTypeType, priceType, travelPrice)
    UPER_ELEMENT_OPTIONAL(int, price)
    UPER_ELEMENT_OPTIONAL(QList<KItinerary::Fcb::v2::VatDetailType>, vatDetail)
    UPER_ELEMENT_DEFAULT(int, typeOfSupplement, 0)
    UPER_ELEMENT_DEFAULT(int, numberOfSupplements, 0)
    UPER_ELEMENT_OPTIONAL(KItinerary::Fcb::v2::LuggageRestrictionType, luggage)
    UPER_ELEMENT_OPTIONAL(QString, infoText)
    UPER_ELEMENT_OPTIONAL(KItinerary::Fcb::v2::ExtensionData, extension)
    UPER_GADGET_FINALIZE
...
class CarCarriageReservationData {
    ...
    UPER_ELEMENT_DEFAULT(KItinerary::Fcb::v2::RoofRackType, roofRackType, norack)
    ...
    UPER_ELEMENT_DEFAULT(KItinerary::Fcb::v2::LoadingDeckType, loadingDeck, LoadingDeckType::upper)
    UPER_ELEMENT_OPTIONAL(QList<int>, carrierNum)
    UPER_ELEMENT_OPTIONAL(QList<QByteArray>, carrierIA5)
    UPER_ELEMENT(KItinerary::Fcb::v2::TariffType, tariff)
    UPER_ELEMENT_DEFAULT(KItinerary::Fcb::v2::PriceTypeType, priceType, travelPrice)
    UPER_ELEMENT_OPTIONAL(int, price)
    UPER_ELEMENT_OPTIONAL(QList<KItinerary::Fcb::v2::VatDetailType>, vatDetail)
    UPER_ELEMENT_OPTIONAL(QString, infoText)
...
class OpenTicketData {
    ...
    UPER_ELEMENT_OPTIONAL(QList<KItinerary::Fcb::v2::RegionalValidityType>, validRegion)
    UPER_ELEMENT_OPTIONAL(KItinerary::Fcb::v2::ReturnRouteDescriptionType, returnDescription)
    UPER_ELEMENT_DEFAULT(int, validFromDay, 0)
    UPER_ELEMENT_OPTIONAL(int, validFromTime)
    UPER_ELEMENT_OPTIONAL(int, validFromUTCOffset)
    UPER_ELEMENT_DEFAULT(int, validUntilDay, 0)
    ...
    UPER_ELEMENT_OPTIONAL(QList<KItinerary::Fcb::v2::VatDetailType>, vatDetail)
    UPER_ELEMENT_OPTIONAL(QString, infoText)
    UPER_ELEMENT_OPTIONAL(QList<KItinerary::Fcb::v2::IncludedOpenTicketType>, includedAddOns)
    UPER_ELEMENT_OPTIONAL(KItinerary::Fcb::v2::LuggageRestrictionType, luggage)
    UPER_ELEMENT_OPTIONAL(QList<int>, includedTransportType)
    UPER_ELEMENT_OPTIONAL(QList<int>, excludedTransportType)
    UPER_ELEMENT_OPTIONAL(KItinerary::Fcb::v2::ExtensionData, extension)
...
class ValidityPeriodDetailType {
    UPER_GADGET
    UPER_ELEMENT_OPTIONAL(QList<KItinerary::Fcb::v2::ValidityPeriodDetailType>, validityPeriod)
    UPER_ELEMENT_OPTIONAL(QList<KItinerary::Fcb::v2::TimeRangeType>, excludedTimeRange)
    UPER_GADGET_FINALIZE
};
...
class PassData {
    ...
    UPER_ELEMENT_OPTIONAL(int, validUntilTime)
    UPER_ELEMENT_OPTIONAL(int, validUntilUTCOffset)
    UPER_ELEMENT_OPTIONAL(KItinerary::Fcb::v2::ValidityPeriodDetailType, validityPeriodDetails)
...
class CustomerCardData {
    UPER_EXTENDABLE_GADGET
    UPER_ELEMENT_OPTIONAL(KItinerary::Fcb::v2::TravelerType, customer)
    UPER_ELEMENT_OPTIONAL(QByteArray, cardIdIA5)
    UPER_ELEMENT_OPTIONAL(int, cardIdNum)
    UPER_ELEMENT(int, validFromYear)
...
class TicketLinkType {
    ...
    UPER_ELEMENT_OPTIONAL(int, productOwnerNum)
    UPER_ELEMENT_OPTIONAL(QByteArray, productOwnerIA5)
    UPER_ELEMENT_DEFAULT(KItinerary::Fcb::v2::TicketType, ticketType, openTicket)
    UPER_ELEMENT_DEFAULT(KItinerary::Fcb::v2::LinkMode, linkMode, issuedTogether)
    UPER_GADGET_FINALIZE
};
...
class DelayConfirmation {
    ...
    UPER_ELEMENT_DEFAULT(KItinerary::Fcb::v2::ConfirmationType, confirmationType, travelerDelayConfirmation)
    UPER_ELEMENT_OPTIONAL(QList<KItinerary::Fcb::v2::TicketLinkType>, affectedTickets)
    UPER_ELEMENT_OPTIONAL(QString, infoText)
    UPER_ELEMENT_OPTIONAL(KItinerary::Fcb::v2::ExtensionData, extension)
    UPER_GADGET_FINALIZE
};
...
class ControlData {
    UPER_EXTENDABLE_GADGET
    UPER_ELEMENT_OPTIONAL(QList <KItinerary::Fcb::v2::CardReferenceType>, identificationByCardReference)
    ...
    UPER_ELEMENT_OPTIONAL(QString, infoText)
    UPER_ELEMENT_OPTIONAL(QList<KItinerary::Fcb::v2::TicketLinkType>, includedTickets)
    UPER_ELEMENT_OPTIONAL(KItinerary::Fcb::v2::ExtensionData, extension)
    UPER_GADGET_FINALIZE
};
...
class KITINERARY_EXPORT UicRailTicketData {
    UPER_EXTENDABLE_GADGET
    UPER_ELEMENT(KItinerary::Fcb::v2::IssuingData, issuingDetail)
    UPER_ELEMENT_OPTIONAL(KItinerary::Fcb::v2::TravelerData, travelerDetail)
    UPER_ELEMENT_OPTIONAL(QList<KItinerary::Fcb::v2::DocumentData>, transportDocument)
    UPER_ELEMENT_OPTIONAL(KItinerary::Fcb::v2::ControlData, controlDetail)
    UPER_ELEMENT_OPTIONAL(QList<KItinerary::Fcb::v2::ExtensionData>, extension)
    UPER_GADGET_FINALIZE
public:
    UicRailTicketData();
