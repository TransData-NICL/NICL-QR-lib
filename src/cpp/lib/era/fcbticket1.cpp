...
constexpr auto FCB_TIME_MAX = 1440;
constexpr auto FCB_BEGIN_DATE_MIN = -1;
constexpr auto FCB_END_DATE_MIN = 0;
constexpr auto FCB_DATE_MAX = 370;

constexpr auto FCB_PRODUCT_ID_NUM_MAX = 32000;
...
// #include "moc_fcbticket1.cpp" // compiled separately via QMAKE_EXTRA_TARGETS
